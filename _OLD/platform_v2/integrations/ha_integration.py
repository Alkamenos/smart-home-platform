...
from OLD.platform_v2.core.ha_bridge import HABridge
...
def _generate_dashboards(manifest):
    ...
    try:
        from OLD.platform_v2.dashboards.generator import generate_all_dashboards
...
def platform_v2_override_clear(entity: str = None):
    """Снять блокировки"""
    from OLD.platform_v2.core.override_manager import OVERRIDE
