...
class TestMigration001:
                    ...
                    "devices": [
                        {
                            ...
                            "name": "Свет 1",
                            "type": "light_motion",
                            "behaviors": [{"template": "motion_light.yaml", "priority": 1}],
                        },
                        {
                            "id": "light_2",
                            "name": "Свет 2",
    ...
    def test_migration_roundtrip(self, old_format_manifest: dict):
        ...
        for orig_zone in old_format_manifest["zones"]:
            reverted_zone = next(z for z in reverted["zones"] if z["id"] == orig_zone["id"])
...
class TestMigrationRunner:
            ...
            "zones": [
                {
                    "id": "room1",
                    "name": "Room 1",
                    "devices": [{"id": "dev1", "name": "Device 1", "type": "light_motion"}],
                }
            ],
            "automation_rules": {
                "lighting": {
    ...
    def test_runner_skip_already_migrated(self, runner: MigrationRunner):
        ...
        new_manifest = {
            ...
            "devices": [
                {"id": "dev1", "name": "Device 1", "type": "light_motion", "room": "room1"}
            ],
            "automation_rules": {
                "lighting": {
                    "motion_enabled": True,
