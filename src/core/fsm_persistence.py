...
class FSMPersistence:
    ...
    def _save_to_file(self, storage_key: str, state: str) -> None:
        ...
        try:
            ...
            self._logger.error(
                f"Failed to save to file: {e}", storage_key=storage_key, error=str(e)
            )

    def _load_state(self, storage_key: str) -> str | None:
        """
    ...
    def _load_from_file(self, storage_key: str) -> str | None:
        ...
        try:
            ...
            self._logger.debug(
                f"Failed to load from file: {e}", storage_key=storage_key, error=str(e)
            )
            return None
